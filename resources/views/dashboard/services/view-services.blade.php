    ...
    <div class="main_container  main_menu_open">
        ...
        <div class="home_pass hidden-xs">
            <ul>
                ...
                <li class="bring_right"><a href=""> الخدمات </a></li>
                <li class="bring_right"><a href="">عرض الخدمات</a></li>
            </ul>
        </div>
        <!--/End system bath-->
        <div class="page_content">
            ...
            <button type="button" class="btn btn-primary" class="add-project-sidebar" href="javascript:void(0)"  data-toggle="modal" data-target="#addProjectSidebar" >إضافة خدمة جديدة</button>
            {{-- add form --}}
            ...
            <div class="wrap">
                <table id="example" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tr>
                        <td>{{$key+1}}</td>
                        <td><img src="{{(!empty($services->image))?url('upload/image/'.$services->image):url('upload/no_image.jfif')}}" width="120px" height="130px" alt="image"></td>
                        <td>{{$services->title_ar}}</td>
                        <td>{{$services->title_en}}</td>
                        <td>{!! $services->description_ar !!}</td>
                        <td>{!! $services->description_en !!}</td>
                        <td>
                            <a href="{{route('services.edit',$services->id)}}" class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="top" title="تعديل"></a>
                            <a href="{{route('services.delete',$services->id)}}" class="glyphicon glyphicon-remove" data-toggle="tooltip" data-placement="top" title="حذف"></a>
                        </td>
                    </tr>
                @endforeach
                </table>
